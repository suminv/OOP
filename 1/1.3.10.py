...
create(self, name) - для создания нового видео с именем name (метод сохраняет имя name в локальном атрибуте name объекта
класса Video);
...
class YouTube:
    ...
    def play(cls, video_indx):
        Video.play(YouTube.videos[video_indx])
